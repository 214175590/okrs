 ...
 * @see com.szkingdom.frame.util.DateUtil
 * 
 */
public final class DateUtil {
	private static ILogger log = (ILogger) LogFactory
			.getDefaultLogger(DateUtil.class);

	/**
	 * SimpleDateFormat日期+时间格式yyyy-MM-dd HH:mm:ss
	 */
	public static final SimpleDateFormat SDF_DATETIME = new SimpleDateFormat(
	 ...
	 * @param dateStr
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#parse
	 */
	 ...
	 * @param date
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#format
	 */
	 ...
	 * @param dateStr
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#parseToTimestamp
	 */
	 ...
	 * @param birthDate
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#getAgeByDate
	 */
	 ...
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#getWeekByDate
	 */
	 ...
	 * @param birthDateStr
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#getAgeByDateStr
	 */
	 ...
	 * @param dayNumber
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#getBeforeOrAfterDateByDayNumber
	 */
	 ...
	 * @param monthNumber
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#getBeforeOrAfterDateByMonthNumber
	 */
	 ...
	 *            比较类型 1:< , 2:> , 3: <= , 4: >= , 5: ==
	 * @return
	 * @see com.szkingdom.frame.util.DateUtil#compareDateOrTime
	 */
	 ...
	 * @return
	 * @see com.szkingdom.web.costanalysis.monotherfee.action.MonOthFeeManagerAction#getLastMonDay
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println(getFirstOfWeek(xx.get(Calendar.YEAR),
				xx.get(Calendar.WEEK_OF_YEAR)));
		System.out.println(getLastOfWeek(xx.get(Calendar.YEAR),
				xx.get(Calendar.WEEK_OF_YEAR)));
	}
